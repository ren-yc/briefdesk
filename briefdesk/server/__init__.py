...
from briefdesk.server.web_plugins import set_plugin_meta_callback as set_plugin_meta_callback
from briefdesk.server.web_plugins import set_plugin_validation_callback as set_plugin_validation_callback
